...
const required = [
  ...
  'src/acquisition/short-link-resolver.js', 'schemas/short-link-resolution.schema.json',
  'gateway/src/index.js', 'gateway/src/redirect-policy.js', 'gateway/wrangler.toml',
  'src/providers/openrouteservice-adapter.js',
  'docs/route-acquisition.html', 'docs/expanding-short-links.html', 'docs/resolver-deployment.html', 'docs/interoperability.html', 'docs/exporting-generated-routes.html',
