...
const errors = [];
const required = ['route-acquisition.html','routing-providers.html','exporting-generated-routes.html','map-backgrounds.html','expanding-short-links.html','resolver-deployment.html','interoperability.html'];
